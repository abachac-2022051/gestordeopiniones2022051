'use strict'
import publicacionesModelo from '../publicaciones/publicacion.model.js'
import categoriaModelo from './categoria.model.js'
...
export const porDefecto = async (id, res) => {
    try {
        ...
        if (!publicacion || publicacion.length === 0) return res.status(400).send({ message: 'Se elimino Exitosamente la categoria no tenia ningun publicacion agregado' })
